...
usará el Math.random para generar los dos números. Crear una clase 
...
public class Ejercicio2Guia9 {
    ...
    public static void main(String[] args) {
        ...
        ParDeNumerosService.mostrarValores(pares);
        ParDeNumerosService.devolverMayor(pares);
        ParDeNumerosService.calcularPotencia(pares);
        ParDeNumerosService.calcularRaiz(pares);
